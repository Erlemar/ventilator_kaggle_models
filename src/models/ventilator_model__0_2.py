...
class VentilatorNet(nn.Module):
    def __init__(self,
        ...
        self.gru1 = nn.LSTM(512 * 2, 384, batch_first=True, bidirectional=True, dropout=0.0, num_layers=1)
        self.gru2 = nn.LSTM(384 * 2, 256, batch_first=True, bidirectional=True, dropout=0.0, num_layers=1)
        self.gru3 = nn.LSTM(256 * 2, 128, batch_first=True, bidirectional=True, dropout=0.0, num_layers=1)
        self.gru4 = nn.LSTM(128 * 2, 64, batch_first=True, bidirectional=True, dropout=0.0, num_layers=1)
